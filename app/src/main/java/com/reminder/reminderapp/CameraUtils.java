...
public class CameraUtils {
    ...
    public static File getOutputMediaFile(int type) {
        ...
        File mediaStorageDir = new File(
                ...
                MainPage.GALLERY_DIRECTORY_NAME);
        ...
        File mediaFile;
        if (type == MainPage.MEDIA_TYPE_IMAGE) {
            mediaFile = new File(mediaStorageDir.getPath() + File.separator
                    + "IMG_" + timeStamp + "." + MainPage.IMAGE_EXTENSION);
        }  else if (type == MainPage.MEDIA_TYPE_VIDEO) {
            mediaFile = new File(mediaStorageDir.getPath() + File.separator
                    + "VID_" + timeStamp + "." + MainPage.VIDEO_EXTENSION);
        }else {
            return null;
        }
